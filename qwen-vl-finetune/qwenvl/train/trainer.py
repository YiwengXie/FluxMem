...
from qwen2_5_vl_fluxmem.modeling_qwen2_5_vl_fluxmem import (
    Qwen2_5_VisionTransformerPretrainedModel,
    Qwen2_5_VLModel,
)
...
def replace_qwen2_vl_attention_class():
    ...
    qwen2_5_vl_fluxmem.modeling_qwen2_5_vl_fluxmem._flash_attention_forward = (
        _flash_attention_forward
    )
    qwen2_5_vl_fluxmem.modeling_qwen2_5_vl_fluxmem.Qwen2_5_VLModel._update_causal_mask = (
        _update_causal_mask
    )
